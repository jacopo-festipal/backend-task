...
- [X] Implement the error handling middleware and use it to properly inform the frontend about issues.
...
- [X] Add support for other LLM models and make this configurable over a parameter. (Feel free to completely rewrite this / use other OpenAIApi SDK functions)
- [X] Generalize the `getAIResponse` function: Change it such that it accepts a configuration that consists of at least a prompt and a model, potentially also additional parameters used for the llm generation.
